...
local themes = {
    ...
    Midnight = {
        ["Accent"] = Color3.fromRGB(0,238,230),
        ["Window Background"] = Color3.fromRGB(10,10,20),
        ["Window Border"] = Color3.fromRGB(18,18,18),
        ["Tab Background"] = Color3.fromRGB(5,5,20),
        ["Tab Border"] = Color3.fromRGB(16,16,16),
        ["Tab Toggle Background"] = Color3.fromRGB(5,5,20),
        ["Section Background"] = Color3.fromRGB(5,5,20),
        ["Section Border"] = Color3.fromRGB(35, 35, 35),
        ["Text"] = Color3.fromRGB(255, 255, 255),
        ["Disabled Text"] = Color3.fromRGB(110, 110, 110),
        ["Object Background"] = Color3.fromRGB(13, 14, 27),
        ["Object Border"] = Color3.fromRGB(5,5,6),
        ["Dropdown Option Background"] = Color3.fromRGB(9,9,9)
    }
}
